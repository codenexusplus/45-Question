...
//Test 6 : Greater  then comparision comparision (Flase)
//agar 3 number 5 se bara hai to true hona chaeye answer
console.log("Is car > 'subaru'? I predict True.");
console.log(cars > 'subaru');
//Test 7 : greater  then or equal comparision comparision (true)
console.log("Is car <= 'subaru'? I predict True.");
console.log(cars <= 'subaru');
//Test 8 : greater  then or equal comparision comparision (true)
console.log("Is car >= 'subaru'? I predict True.");
console.log(cars >= 'subaru');
